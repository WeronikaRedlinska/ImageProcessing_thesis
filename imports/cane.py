...
def cane_2d(org_img, smooth_degree, window_size=9, iter_N=30, kappa1=2, kappa2=2, kappa3=2000):
...
def cane_3d(org_img, smooth_degree, window_size=9, iter_N=25, kappa1=2, kappa2=2, kappa3=2000):
